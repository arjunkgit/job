                    ...
                    <div class="panel-body">
                        <form novalidate name="userForm">
                            <div class="form-group">
                                ...
                                <input required ngFocus="true" data-ng-minlength="3" required type="text" class="form-control" id="jobName" name="jobName"
                                    placeholder="Name" data-ng-model='tempUser.jobName'>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="jobDesc" name="jobDesc" rows="5" placeholder="Job Description" data-ng-model='tempUser.jobDesc'></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="minSalary" name="minSalary" placeholder="Min Salary" data-ng-model='tempUser.minSalary'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="maxSalary" name="maxSalary" placeholder="Max Salary" data-ng-model='tempUser.maxSalary'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jobExp" name="jobExp" placeholder="jobExperiance" data-ng-model='tempUser.jobExp'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="qua" name="qua" placeholder="Qualification" data-ng-model='tempUser.qua'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="city" name="city" placeholder="City" data-ng-model='tempUser.city'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="state" name="state" placeholder="state" data-ng-model='tempUser.state'>
                            ...
                            <div class="text-center">
                                <button ng-disabled="userForm.$invalid" data-loading-text="Saving User..." ng-hide="editMode" type="{{editMode == true ? 'button' : 'submit'}}"
                                    class="btn btn-save" data-ng-click="addUser()">Save Job</button>
                                <button ng-disabled="userForm.$invalid" data-loading-text="Updating User..." ng-hide="!editMode" type="{{!editMode == true ? 'button' : 'submit'}}"
                                    class="btn btn-save" data-ng-click="updateUser()">Update
                                    Job</button>
                            </div>
                                    ...
                                    <tbody>
                                        <tr ng-repeat="row in $data track by $index">
                                            ...
                                            <td data-title="'Action'">
                                                ...
                                                <button class="btn btn-info btn-sm" data-ng-click="deleteUser(row)" style="cursor: pointer;">
                        ...
                        <md-content layout-padding>
                            <form name="projectForm">
                                ...
                                <md-input-container class="md-block">
                                    ...
                                    <input md-maxlength="50" required md-no-asterisk name="companyname" ng-disabled="isEdit" ng-model="profile[0].companyname">
                                    <div ng-messages="projectForm.companyname.$error">
                                        <div ng-message="required">This is required.</div>
                                        <div ng-message="md-maxlength">The company name must be less than 30 characters long.</div>
                                    </div>
                                </md-input-container>
                                <div layout="row">
                                ...
                                <div class="text-center">
                                    <button ng-disabled="!projectForm.$dirty" data-loading-text="Updating User..." ng-disabled="true" type="submit" class="btn btn-save"
                                        data-ng-click="updateProfile(profile[0])">Update
                                        Profile</button>
                                </div>
                            </form>
                        </md-content>
                    ...
                    <div class="panel-body">
                        <form novalidate name="userFormData">
                            <div class="form-group" ng-show="editUserMode">
                                <label>User ID</label>
                                <input type="text" class="form-control" ng-disabled="true" id="userId" name="userId" data-ng-model='tempUserData.userId'>
                            </div>
                            <div class="form-group">
                                <label>User Name</label>
                                <input required ngFocus="true" data-ng-minlength="3" required type="text" class="form-control" id="userName" name="userName"
                                    placeholder="Enter User Name" data-ng-model='tempUserData.userName'>
                            ...
                            <div class="form-group">
                                ...
                                <input required ngFocus="true" data-ng-minlength="3" required type="text" class="form-control" id="userEmail" name="userEmail"
                                    placeholder="Enter User Email Id" data-ng-model='tempUserData.userEmail'>
                            ...
                            <div class="form-group">
                                ...
                                <input required ngFocus="true" data-ng-minlength="3" required type="text" class="form-control" id="userPass" name="userPass"
                                    placeholder="Enter User Password" data-ng-model='tempUserData.userPass'>
                            ...
                            <!-- <input type="hidden" data-ng-model='tempUser.id'>  -->
                            <div class="text-center">
                                <button ng-disabled="userFormData.$invalid" data-loading-text="Saving User..." ng-hide="editUserMode" type="submit" class="btn btn-save"
                                    data-ng-click="addUserData()">Save User</button>
                                <button ng-disabled="userFormData.$invalid" data-loading-text="Updating User..." ng-hide="!editUserMode" type="submit" class="btn btn-save"
                                    data-ng-click="updateUserData()">Update USer</button>
                            </div>
                        </form>
                    </div>
                </div>
                                            ...
                                            <td data-title="'Email'">
                                                ...
                                                {{ row.totalExp }}</td>
																						<td data-title="'Mobile'">
																								{{ row.mobile }}</td>
                                            <td data-title="'Action'">
                                                <button class="btn btn-info btn-sm" data-ng-click="deleteUserName(row)" style="cursor: pointer;">
                                                    <span class="glyphicon glyphicon-remove"></span>
                                                </button>
                                            </td>
                                        </tr>
