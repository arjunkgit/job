...
<body ng-app="adminModule" ng-controller="mainCtrl">
  <section layout="row" flex>
    ...
    <md-sidenav  layout="column" style="height:100vh;"
        class="md-sidenav-left flex"
        md-component-id="left"
        md-is-locked-open="$mdMedia('gt-md')"
        md-whiteframe="4">

      <md-toolbar class="md-theme-indigo" style="flex-direction: row;">
		<span style="flex-grow: 7"><h1 class="md-toolbar-tools">List of options</h1></span>
		<span ng-click="closeLeft()" hide-gt-md style="flex-grow: 3"><h1 class="md-toolbar-tools">close</h1></span>
      </md-toolbar>
    ...
    <md-content flex>
	    <md-toolbar class="md-hue-2">
	      <div class="md-toolbar-tools">
			<md-button ng-click="toggleLeft()" aria-label="Settings" ng-disabled="false"
				class="md-icon-button" show-md hide-gt-md>
