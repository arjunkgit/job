...
<div class="container" style="padding-bottom: 10px;margin-bottom: 130px;">
	<div class="row">
		<div class="col-md-4">
		&nbsp;
		</div>	
		<div class="col-md-4 vqBox" style="padding: 15px;">
          <form action="login.php" method="post" name="login" role="form">
            ...
            <div class="checkbox">
              ...
              <button type="submit" class="btn btn-success btn-block" name="candidateLoginSubmit">
